...
export default function PrivacyPage() {
  return (
    <LegalPage
      ...
      description="How Real Business Suite handles company, user, and business records."
    >
      <h2>What we collect</h2>
      <p>Real Business Suite stores the information your company enters into the platform, including account details, company profile data, customers, employees, invoices, quotes, projects, tasks, inventory, expenses, audit logs, and queued emails.</p>
      ...
      <h2>Contact</h2>
      <p>For privacy questions or data requests, contact your company owner/admin or the Real Business Suite support contact listed on the support page.</p>
    </LegalPage>
  );
}
