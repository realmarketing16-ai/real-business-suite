...
addCheck('Env example launch vars', includesAll(envExample, ['DATABASE_URL', 'JWT_SECRET', 'WEB_URL', 'NEXT_PUBLIC_API_URL', 'EMAIL_DRY_RUN', 'STRIPE_SECRET_KEY', 'STRIPE_WEBHOOK_SECRET']), '.env.example documents launch-critical variables.');
