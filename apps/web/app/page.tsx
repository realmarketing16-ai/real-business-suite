  ...
  return (
    <main className="landing">
      ...
      <section className="hero shell">
        <div>
          <p className="eyebrow">{brand.regionLine}</p>
        ...
        <div className="preview">
          ...
          <div className="metricGrid">
            <div><b>4,230</b><span>Employees</span></div><div><b>{brand.demoRevenue}</b><span>Revenue</span></div><div><b>96</b><span>Open jobs</span></div><div><b>18</b><span>Campaigns</span></div>
          </div>
